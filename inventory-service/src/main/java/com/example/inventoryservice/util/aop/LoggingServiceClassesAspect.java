...
import static com.example.inventoryservice.util.aop.LogColorConstants.*;
...
public class LoggingServiceClassesAspect {
    ...
    @Pointcut("execution(public * com.example.inventoryservice.service..*.*(..))")
    public void callAtMyServicesPublicMethods() {
    }

    @Pointcut("execution(public * com.example.inventoryservice.repository..*.*(..))")
    public void callAtRepo() {
    }

    @Pointcut("execution(public * com.example.inventoryservice.eventhandler..*.*(..))")
